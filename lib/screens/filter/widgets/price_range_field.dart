...
import 'package:porissotoquebrado/helpers/format_field.dart';
          ...
          child: TextFormField(
            ...
            onSaved: (s) {
              if (s.isEmpty)
                ...
                filter.minPrice = int.parse(getStanitizedText(s));
            },
            validator: (s) {
              if (s.isNotEmpty && int.tryParse(getStanitizedText(s)) == null)
          ...
          child: TextFormField(
            ...
            onSaved: (s) {
              if (s.isEmpty)
                ...
                filter.maxPrice = int.parse(getStanitizedText(s));
            },
            validator: (s) {
              if (s.isNotEmpty && int.tryParse(getStanitizedText(s)) == null)
                return 'Utilize valores válidos';
